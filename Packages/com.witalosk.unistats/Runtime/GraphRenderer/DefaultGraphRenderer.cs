...
namespace UniStats
{
    ...
    {
        public RenderTexture GetGraphTexture(IHistoryManager<float> historyManager, ColorConfig colorConfig)
        {
            ...
            _graphMaterial.SetFloat("_MinValue", historyManager.MinValue);
            _graphMaterial.SetFloat("_MaxValue", historyManager.MaxValue);
